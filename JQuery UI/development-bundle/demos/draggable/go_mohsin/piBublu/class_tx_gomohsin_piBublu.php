 ...
 * @subpackage	piBublu
 */
class tx_gomohsin_piBublu extends tx_gopibase {
	public $prefixId      = 'tx_gomohsin_piBublu';	// Same as class name
	public $scriptRelPath = 'piBublu/class.tx_gomohsin_piBublu.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_mohsin/piBublu/class.tx_gomohsin_piBublu.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_mohsin/piBublu/class.tx_gomohsin_piBublu.php']);
}
