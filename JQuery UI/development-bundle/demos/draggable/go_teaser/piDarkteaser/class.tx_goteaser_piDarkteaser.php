...
/**
 * Plugin 'piDarkteaser' for the 'go_content' extension.
 *
 * @author	Mansoor Ahmad <mansoor@gosign.de>
 * @package	TYPO3
 * @subpackage	piDarkteaser
 */
class tx_goteaser_piDarkteaser extends tx_gopibase {
	public $prefixId      = 'tx_goteaser_piDarkteaser';	// Same as class name
	public $scriptRelPath = 'piDarkteaser/class.tx_goteaser_piDarkteaser.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_teaser/piDarkteaser/class.tx_goteaser_piDarkteaser.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_teaser/piDarkteaser/class.tx_goteaser_piDarkteaser.php']);
}
