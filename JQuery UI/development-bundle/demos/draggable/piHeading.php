...
/**
 * Plugin 'piHeading' for the 'go_content' extension.
 *
 * @author	Mohsin Khan <mohsin@cassini.gosign.de>
 * @package	TYPO3
 * @subpackage	piHeading
 */
class tx_goteaser_piHeading extends tx_gopibase {
	public $prefixId      = 'tx_goteaser_piHeading';	// Same as class name
	public $scriptRelPath = 'piHeading/class.tx_goteaser_piHeading.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_teaser/piHeading/class.tx_goteaser_piHeading.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/go_teaser/piHeading/class.tx_goteaser_piHeading.php']);
}
